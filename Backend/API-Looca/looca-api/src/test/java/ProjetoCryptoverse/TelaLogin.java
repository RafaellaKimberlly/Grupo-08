...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(passwordUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(msgError, javax.swing.GroupLayout.PREFERRED_SIZE, 13, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        imgLogo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        imgLogo.setText("Entre com suas redes sociais");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ConnectionBD configBanco = new ConnectionBD();
        JdbcTemplate controller = new JdbcTemplate(configBanco.getDataSource());

        
        List<Usuario> usuario = controller.query(String.format("Select * from tbUsuario where email = '%s' and senha = '%s';", txtUsuario.getText(), passwordUsuario.getText()), new BeanPropertyRowMapper(Usuario.class));
